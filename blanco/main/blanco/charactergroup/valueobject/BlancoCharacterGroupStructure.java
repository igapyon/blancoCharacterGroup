 ...
 */
public class BlancoCharacterGroupStructure {
    /**
     * フィールド [name]
     *
     * 項目の型 [java.lang.String]<br>
     * 文字グループIDを指定します。必須項目です。
     */
     ...
     * フィールド [fieldList]
     *
     * 項目の型 [java.util.List<blanco.charactergroup.valueobject.BlancoCharacterGroupFieldStructure>]<br>
     * 規定値   [new java.util.ArrayList<blanco.charactergroup.valueobject.BlancoCharacterGroupFieldStructure>()]<br>
     * フィールドを保持するリスト。
     */
    private List<blanco.charactergroup.valueobject.BlancoCharacterGroupFieldStructure> fFieldList = new java.util.ArrayList<blanco.charactergroup.valueobject.BlancoCharacterGroupFieldStructure>();
     ...
     */
    public void setFieldList(final List<blanco.charactergroup.valueobject.BlancoCharacterGroupFieldStructure> argFieldList) {
     ...
     */
    public List<blanco.charactergroup.valueobject.BlancoCharacterGroupFieldStructure> getFieldList() {
        return fFieldList;
    }
    ...
    public String toString() {
        ...
        buf.append("blanco.charactergroup.valueobject.BlancoCharacterGroupStructure[");
