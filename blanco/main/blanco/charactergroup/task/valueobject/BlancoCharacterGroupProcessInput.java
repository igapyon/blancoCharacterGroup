 ...
 */
package blanco.charactergroup.task.valueobject;

/**
 * 処理クラス [BlancoCharacterGroupProcess]の入力バリューオブジェクトクラスです。
 */
public class BlancoCharacterGroupProcessInput {
    /**
     * フィールド [verbose]
     *
     * 項目の型 [boolean]<br>
     ...
     * 項目の型 [java.lang.String]<br>
     * 規定値   [java]<br>
     * ターゲットとなるプログラミング言語処理系名。java, cs, js, vb, phpが選択可能
     */
    ...
    public String toString() {
        ...
        buf.append("blanco.charactergroup.task.valueobject.BlancoCharacterGroupProcessInput[");
