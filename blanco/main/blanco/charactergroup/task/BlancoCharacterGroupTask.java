 ...
 * Apache Antタスク [BlancoCharacterGroup]のクラス
 */
 ...
 * Apache Antタスク [BlancoCharacterGroup]のクラス。
 *
 * 定数定義書から定数クラスを自動生成するためのAntTaskです。<br>
 * このクラスでは、Apache Antタスクで一般的に必要なチェックなどのコーディングを肩代わりします。
 * 実際の処理は パッケージ[blanco.charactergroup.task]にBlancoCharacterGroupBatchProcessクラスを作成して記述してください。<br>
 * <br>
 * Antタスクへの組み込み例<br>
 * <pre>
...
public class BlancoCharacterGroupTask extends Task {
     ...
     *
     * 項目番号: 5<br>
     * ターゲットとなるプログラミング言語処理系名。java, cs, js, vb, phpが選択可能<br>
     *
     * @param arg セットしたい値
     */
